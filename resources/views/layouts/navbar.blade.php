            ...
            <div class="hidden lg:flex items-center space-x-0.5">
                ...
                <div x-data="{ profilOpen: false }" @click.away="profilOpen = false" class="relative">
                    <button @click="profilOpen = !profilOpen"
                        class="relative px-3 py-2.5 rounded-xl font-medium text-sm transition-all duration-300 group
                              {{ request()->is('filosofi*') || request()->is('struktural*') ? 'text-white' : 'text-gray-700 hover:text-blue-600' }}">
                        @if (request()->is('filosofi*') || request()->is('struktural*'))
                            <span
                                class="absolute inset-0 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl shadow-lg"></span>
                            <span class="relative flex items-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div x-show="profilOpen" x-transition:enter="transition ease-out duration-200"
                        ...
                        <a href="{{ route('guest.profil.filosofi') }}"
                            class="block px-4 py-3 text-sm font-medium transition-all duration-300
                                  {{ request()->routeIs('guest.profil.filosofi') ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white' : 'text-gray-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 hover:text-blue-600' }}">
                        ...
                        <a href="/struktural"
                            class="block px-4 py-3 text-sm font-medium transition-all duration-300
                                  {{ request()->is('struktural*') ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white' : 'text-gray-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 hover:text-blue-600' }}">
                            <div class="flex items-center gap-3">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div x-data="{ profilMobileOpen: false }">
                <button @click="profilMobileOpen = !profilMobileOpen"
                    class="w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl font-medium text-sm transition-all duration-300
                          {{ request()->is('filosofi*') || request()->is('struktural*') ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-lg' : 'text-gray-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 hover:text-blue-600' }}">
                    <div class="flex items-center gap-3">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                ...
                <div x-show="profilMobileOpen" x-transition:enter="transition ease-out duration-200"
                    ...
                    <a href="/filosofi"
                        class="flex items-center gap-3 px-4 py-2.5 rounded-xl font-medium text-sm transition-all duration-300
                              {{ request()->is('filosofi*') ? 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white shadow-md' : 'text-gray-600 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 hover:text-blue-600' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                        </svg>
                    ...
                    <a href="/struktural"
                        class="flex items-center gap-3 px-4 py-2.5 rounded-xl font-medium text-sm transition-all duration-300
                              {{ request()->is('struktural*') ? 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white shadow-md' : 'text-gray-600 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 hover:text-blue-600' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                        </svg>
