<!-- Add Prosedur Modal -->
<div id="add-prosedur-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl h-full flex items-center justify-center">
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-h-[90vh] flex flex-col">
            ...
            <div
                ...
                <div class="relative flex items-center justify-between">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="add-prosedur-modal">
            ...
            <!-- Modal body -->
            <form action="{{ route('admin.prosedur-partnership.lainnya.store', $partnership->id) }}" method="POST"
                    ...
                    <div
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <textarea id="prosedur" name="prosedur" rows="8"
                ...
                <div
                    ...
                    <button type="button" data-modal-hide="add-prosedur-modal"
