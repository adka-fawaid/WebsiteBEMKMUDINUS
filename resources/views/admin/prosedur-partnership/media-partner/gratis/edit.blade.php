<!-- Edit Modal Prosedur -->
<div id="edit-prosedur-modal-{{ $prosedur->id }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl h-full flex items-center justify-center">
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-h-[90vh] flex flex-col">
            ...
            <div
                ...
                <div class="relative flex items-center justify-between">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="edit-prosedur-modal-{{ $prosedur->id }}">
            ...
            <!-- Modal body -->
            <form
                action="{{ route('admin.prosedur-partnership.media-partner.gratis.update', [$partnership->id, $prosedur->id]) }}"
                ...
                <div
                    ...
                    <button type="button" data-modal-hide="edit-prosedur-modal-{{ $prosedur->id }}"
