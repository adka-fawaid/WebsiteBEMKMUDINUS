<!-- Media Partner Gratis Table -->
<div class="overflow-x-auto">
    <div class="flex items-center justify-between mb-4">
        <h3 class="text-lg font-bold text-gray-900">Prosedur Media Partner Gratis</h3>
        <button type="button" data-modal-target="add-prosedur-modal" data-modal-toggle="add-prosedur-modal"
    ...
    <table class="w-full">
        ...
        <tbody>
            @forelse ($prosedurMedpartGratis as $index => $prosedur)
                <tr
                    ...
                    <td class="px-6 py-5">
                        <div class="flex items-center justify-center gap-2">
                            <button type="button" data-modal-target="edit-prosedur-modal-{{ $prosedur->id }}"
                            ...
                            <button type="button" data-modal-target="delete-prosedur-modal-{{ $prosedur->id }}"
                ...
                <!-- Include Edit Modal -->
                @include('admin.prosedur-partnership.media-partner.gratis.edit', [
                    'prosedur' => $prosedur,
                    'partnership' => $partnership,
                ])

                <!-- Include Delete Modal -->
                @include('admin.prosedur-partnership.media-partner.gratis.delete', [
                    'prosedur' => $prosedur,
                    'partnership' => $partnership,
                ])
            @empty
...
@include('admin.prosedur-partnership.media-partner.gratis.create', ['partnership' => $partnership])
