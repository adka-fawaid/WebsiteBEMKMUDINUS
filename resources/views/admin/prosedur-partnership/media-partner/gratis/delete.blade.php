...
<div id="delete-prosedur-modal-{{ $prosedur->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full">
            ...
            <div class="relative p-6 bg-gradient-to-br from-red-600 via-red-500 to-rose-600 overflow-hidden">
                ...
                <div class="relative flex items-center justify-between">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="delete-prosedur-modal-{{ $prosedur->id }}">
            ...
            <div class="p-6">
                ...
                <div class="flex items-center justify-end gap-3">
                    <!-- Action buttons -->
                    <form
                        action="{{ route('admin.prosedur-partnership.media-partner.gratis.destroy', [$partnership->id, $prosedur->id]) }}"
                        method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="button" data-modal-hide="delete-prosedur-modal-{{ $prosedur->id }}"
