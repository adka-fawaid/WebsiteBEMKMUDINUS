<!-- Media Partner Berbayar Table -->
<div class="overflow-x-auto">
    <div class="flex items-center justify-between mb-4">
        <h3 class="text-lg font-bold text-gray-900">Prosedur Media Partner Berbayar</h3>
        <button type="button" data-modal-target="add-prosedur-berbayar-modal"
            data-modal-toggle="add-prosedur-berbayar-modal"
            class="text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 font-semibold rounded-lg text-sm px-5 py-2.5 transition-all duration-150 flex items-center gap-2 shadow-lg hover:shadow-xl">
    ...
    <table class="w-full">
        <thead>
            <tr class="bg-gradient-to-r from-gray-50 to-blue-50 border-b border-gray-200">
                ...
                <th scope="col" class="px-6 py-4 text-center font-bold">
                    <span class="text-xs font-extrabold text-gray-700 uppercase tracking-wider">Prosedur</span>
                </th>
        ...
        <tbody>
            @forelse ($prosedurMedpartBerbayar as $index => $prosedur)
                <tr
                    ...
                    <td class="px-6 py-5">
                        <div class="flex items-center justify-center gap-2">
                            <button type="button" data-modal-target="edit-prosedur-berbayar-modal-{{ $prosedur->id }}"
                                data-modal-toggle="edit-prosedur-berbayar-modal-{{ $prosedur->id }}"
                            ...
                            <button type="button"
                                data-modal-target="delete-prosedur-berbayar-modal-{{ $prosedur->id }}"
                                data-modal-toggle="delete-prosedur-berbayar-modal-{{ $prosedur->id }}"
                ...
                <!-- Include Edit Modal -->
                @include('admin.prosedur-partnership.media-partner.berbayar.edit', [
                    'prosedur' => $prosedur,
                    'partnership' => $partnership,
                ])

                <!-- Include Delete Modal -->
                @include('admin.prosedur-partnership.media-partner.berbayar.delete', [
                    'prosedur' => $prosedur,
                    'partnership' => $partnership,
                ])
            @empty
                <tr>
                    <td colspan="3" class="px-6 py-16 text-center">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <p class="text-sm text-gray-500">Belum ada data prosedur. Klik tombol "Tambah Prosedur"
                                untuk
                                menambah data.</p>
                        </div>
                    </td>
...
<!-- Include Create Prosedur Modal -->
@include('admin.prosedur-partnership.media-partner.berbayar.create', ['partnership' => $partnership])
