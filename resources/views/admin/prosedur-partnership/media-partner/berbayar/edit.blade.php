<!-- Edit Modal Prosedur -->
<div id="edit-prosedur-berbayar-modal-{{ $prosedur->id }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl h-full flex items-center justify-center">
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-h-[90vh] flex flex-col">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-xs font-semibold text-yellow-100 uppercase tracking-wider mb-1">
                                Edit Data</p>
                            <h3 class="text-xl md:text-2xl font-bold text-white leading-tight">Edit Prosedur
                            </h3>
                        </div>
                    </div>
                    <button type="button"
                        ...
                        data-modal-hide="edit-prosedur-berbayar-modal-{{ $prosedur->id }}">
            ...
            <!-- Modal body -->
            <form
                action="{{ route('admin.prosedur-partnership.media-partner.berbayar.update', [$partnership->id, $prosedur->id]) }}"
                ...
                <div class="flex-1 overflow-y-auto p-4 md:p-6">
                    <div
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                <label for="prosedur-berbayar-{{ $prosedur->id }}"
                                    class="block text-xs font-medium text-gray-900 uppercase tracking-wide mb-2">Deskripsi
                                    Prosedur</label>
                                <textarea id="prosedur-berbayar-{{ $prosedur->id }}" name="prosedur" rows="8"
                                    ...
                                    placeholder="Masukkan deskripsi prosedur..." required>{{ $prosedur->prosedur }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <button type="button" data-modal-hide="edit-prosedur-berbayar-modal-{{ $prosedur->id }}"
