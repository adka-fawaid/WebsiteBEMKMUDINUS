<!-- Delete Modal -->
<div id="delete-kontak-modal-{{ $kontak->id }}" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl font-bold text-white leading-tight">Hapus Kontak</h3>
                        </div>
                    </div>
                    <button type="button"
                        ...
                        data-modal-hide="delete-kontak-modal-{{ $kontak->id }}">
            ...
            <div class="p-6">
                <div class="flex items-start gap-4 mb-6">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600 leading-relaxed mb-3">
                            Anda akan menghapus kontak <strong>{{ $kontak->tipe }}</strong>:
                            <strong>{{ $kontak->kontak }}</strong>.
                        </p>
                ...
                <div class="flex items-center justify-end gap-3">
                    <form action="{{ route('admin.kontak.destroy', $kontak->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="button" data-modal-hide="delete-kontak-modal-{{ $kontak->id }}"
