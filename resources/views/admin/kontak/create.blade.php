<!-- Add Kontak Modal -->
<div id="add-kontak-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-h-[90vh] flex flex-col">
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl md:text-2xl font-bold text-white leading-tight">Kontak Baru</h3>
                        </div>
                    </div>
                    <button type="button"
                        ...
                        data-modal-hide="add-kontak-modal">
            ...
            <form action="{{ route('admin.kontak.store') }}" method="POST"
                ...
                <div
                    ...
                    <button type="button" data-modal-hide="add-kontak-modal"
