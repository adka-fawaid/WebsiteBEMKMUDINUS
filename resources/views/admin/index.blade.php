    ...
    <main class="ml-0 md:ml-64 peer-checked:md:ml-0 transition-all duration-300">
        <section class="pt-24 px-8 pb-10 bg-[#e8eaf0] min-h-screen">
            <div class="max-w-7xl mx-auto px-3">
                ...
                <div class="mb-6">
                    <nav class="text-sm text-gray-500">
                        <ol class="list-reset flex items-center space-x-2">
                            ...
                            <li class="text-blue-700 font-semibold">Dashboard</li>
                        </ol>
                ...
                <!-- Welcome Card -->
                <div class="mb-6 bg-gradient-to-r from-blue-800 to-blue-600 rounded-lg shadow-lg p-6 text-white">
                ...
                <!-- Informasi Event -->
                @if ($events)
                    <div class="mb-6 mt-6 bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-600">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="bg-blue-50 rounded-lg p-4">
                                ...
                                <p class="text-lg font-bold text-blue-700">{{ $events->short_title ?? '-' }}</p>
                            </div>
                            <div class="bg-blue-50 rounded-lg p-4">
                                <p class="text-sm text-gray-600 mb-1">Judul Lengkap</p>
                                <p class="text-lg font-bold text-blue-700">{{ $events->long_title ?? '-' }}</p>
                            </div>
                            <div class="bg-blue-50 rounded-lg p-4">
