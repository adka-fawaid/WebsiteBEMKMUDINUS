<!-- Modal Show Detail Sambutan Presma -->
<div id="show-modal-{{ $sambutanPresma->id }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-3xl h-full flex items-center justify-center">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-h-[90vh] flex flex-col">
            ...
            <div
                ...
                <div class="relative flex items-center justify-between">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="show-modal-{{ $sambutanPresma->id }}">
            ...
            <div class="p-4 md:p-6 space-y-6 overflow-y-auto flex-1">
                    ...
                    <div class="md:col-span-1 flex justify-center">
                        <div class="relative">
                            <img src="{{ asset('storage/img/presiden-mahasiswa/' . $sambutanPresma->foto) }}"
                                ...
                                class="w-48 h-64 object-cover rounded-lg shadow-lg border-4 border-blue-100">
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2 space-y-3">
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    <p class="text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Nama
                                        Lengkap</p>
                                    <p class="text-lg font-bold text-gray-900">{{ $sambutanPresma->nama }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">NIM
                                        </p>
                                        <p class="text-base font-bold text-gray-900">{{ $sambutanPresma->nim }}</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">
                                            Angkatan</p>
                                        <p class="text-base font-bold text-gray-900">{{ $sambutanPresma->angkatan }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    <p class="text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Program
                                        Studi</p>
                                    <p class="text-base font-bold text-gray-900">{{ $sambutanPresma->program_studi }}
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div
                    ...
                    <div class="flex items-center gap-3 mb-5 pb-4 border-b border-gray-100">
                        ...
                        <div>
                            <p class="text-xs font-medium text-gray-500 uppercase tracking-wide">Kata Sambutan</p>
                            <p class="text-sm text-gray-600">Presiden Mahasiswa BEM KM UDINUS</p>
                        </div>
                    </div>
                    <div class="relative">
                        <svg class="absolute top-0 left-0 w-8 h-8 text-indigo-100 -translate-x-1 -translate-y-1"
                        ...
                        <div class="pl-6 pr-6">
                            <p class="text-gray-700 leading-relaxed text-justify whitespace-pre-line">
                                {{ $sambutanPresma->sambutan }}</p>
                        </div>
                        <svg class="absolute bottom-0 right-0 w-8 h-8 text-indigo-100 translate-x-1 translate-y-1 rotate-180"
                            fill="currentColor" viewBox="0 0 32 32">
                            <path
                                d="M9.352 4C4.456 7.456 1 13.12 1 19.36c0 5.088 3.072 8.064 6.624 8.064 3.36 0 5.856-2.688 5.856-5.856 0-3.168-2.208-5.472-5.088-5.472-.576 0-1.344.096-1.536.192.48-3.264 3.552-7.104 6.624-9.024L9.352 4zm16.512 0c-4.8 3.456-8.256 9.12-8.256 15.36 0 5.088 3.072 8.064 6.624 8.064 3.264 0 5.856-2.688 5.856-5.856 0-3.168-2.304-5.472-5.184-5.472-.576 0-1.248.096-1.44.192.48-3.264 3.456-7.104 6.528-9.024L25.864 4z" />
                        </svg>
            ...
            <div class="flex items-center justify-end p-4 md:p-5 border-t border-gray-200 flex-shrink-0">
                <button data-modal-hide="show-modal-{{ $sambutanPresma->id }}" type="button"
