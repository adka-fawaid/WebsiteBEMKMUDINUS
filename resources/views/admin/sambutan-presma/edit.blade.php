                        ...
                        <div class="md:col-span-2">
                            <div
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        <label for="nama"
                                            class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">Nama
                                            Lengkap</label>
                        ...
                        <div>
                            <div
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        <label for="nim"
                                            class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">NIM</label>
                        ...
                        <div>
                            <div
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        <label for="angkatan"
                                            class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">Angkatan</label>
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        <label for="program_studi"
                                            class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">Program
                                            Studi</label>
                        ...
                        <div class="md:col-span-2">
                            <div
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        <label for="sambutan"
                                            class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">Kata
                                            Sambutan</label>
