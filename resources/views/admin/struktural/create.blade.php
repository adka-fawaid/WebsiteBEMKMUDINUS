<!-- Add Struktural Modal -->
<div id="add-struktural-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-h-[90vh] flex flex-col">
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl md:text-2xl font-bold text-white leading-tight">Struktural Baru</h3>
                        </div>
                    </div>
                    <button type="button"
                        ...
                        data-modal-hide="add-struktural-modal">
            ...
            <form action="{{ route('admin.struktural.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Upload logo (max 5MB)</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <textarea id="deskripsi" name="deskripsi" rows="6"
                                    ...
                                    placeholder="Masukkan deskripsi unit organisasi..." required></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <button type="button" data-modal-hide="add-struktural-modal"
