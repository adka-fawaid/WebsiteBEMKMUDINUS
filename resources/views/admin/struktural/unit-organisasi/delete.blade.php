...
<div id="delete-anggota-modal-{{ $anggota->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full">
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl font-bold text-white leading-tight">Hapus Anggota</h3>
                        </div>
                    </div>
                    <button type="button"
                        ...
                        data-modal-hide="delete-anggota-modal-{{ $anggota->id }}">
            ...
            <div class="p-6">
                <div class="flex items-start gap-4 mb-6">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600 leading-relaxed mb-3">
                            Anda akan menghapus anggota <strong>{{ $anggota->nama }}</strong> dengan jabatan
                ...
                <div class="flex items-center justify-end gap-3">
                    <form
                        action="{{ route('admin.struktural.unit-organisasi.anggota.destroy', [$anggota->unit_organisasi_id, $anggota->id]) }}"
                        method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="button" data-modal-hide="delete-anggota-modal-{{ $anggota->id }}"
