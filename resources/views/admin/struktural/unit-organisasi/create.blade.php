<!-- Add Anggota Modal -->
<div id="add-anggota-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl h-full flex items-center justify-center">
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-h-[90vh] flex flex-col">
            ...
            <div
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-xs font-semibold text-green-100 uppercase tracking-wider mb-1">Tambah Anggota
                            </p>
                            <h3 class="text-xl md:text-2xl font-bold text-white leading-tight">Anggota Baru</h3>
                        </div>
                    </div>
                    <button type="button"
                        ...
                        data-modal-hide="add-anggota-modal">
            ...
            <!-- Modal body -->
            <form action="{{ route('admin.struktural.unit-organisasi.anggota.store', $unitOrganisasi->id) }}"
                    ...
                    <div
                        ...
                        <div class="flex flex-col md:flex-row gap-4 items-start">
                            ...
                            <div class="flex-shrink-0">
                                <div id="image-preview-anggota" class="hidden">
                                    <img id="preview-img-anggota" src="" alt="Preview"
                                        class="w-40 h-40 object-cover rounded-xl shadow-md border-2 border-gray-200">
                                </div>
                                <div id="no-preview-anggota"
                            ...
                            <div class="flex-1">
                                <div
                                    ...
                                    <input type="file" id="foto" name="foto" accept="image/*"
                                        ...
                                        onchange="previewImageAnggota(event)" required>
                                ...
                                <p class="mt-2 text-xs text-gray-500" id="file-name-anggota"></p>
                            </div>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <button type="button" data-modal-hide="add-anggota-modal"
...
<script>
    function previewImageAnggota(event) {
        const input = event.target;
        const preview = document.getElementById('preview-img-anggota');
        const imagePreview = document.getElementById('image-preview-anggota');
        const noPreview = document.getElementById('no-preview-anggota');
        const fileName = document.getElementById('file-name-anggota');
