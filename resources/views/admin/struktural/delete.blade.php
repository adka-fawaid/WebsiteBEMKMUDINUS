<!-- Delete Modal -->
<div id="delete-struktural-modal-{{ $item->id }}" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl font-bold text-white leading-tight">Hapus Struktural</h3>
                        </div>
                    </div>
                    <button type="button"
                        ...
                        data-modal-hide="delete-struktural-modal-{{ $item->id }}">
            ...
            <div class="p-6">
                <div class="flex items-start gap-4 mb-6">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600 leading-relaxed mb-3">
                            Anda akan menghapus data struktural <strong>{{ $item->nama }}</strong>.
                        </p>
                ...
                <div class="flex items-center justify-end gap-3">
                    <form action="{{ route('admin.struktural.destroy', $item->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="button" data-modal-hide="delete-struktural-modal-{{ $item->id }}"
