<!-- Edit Modal for each Misi -->
<div id="edit-misi-modal-{{ $misi->id }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl h-full flex items-center justify-center">
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-h-[90vh] flex flex-col">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-xs font-semibold text-yellow-100 uppercase tracking-wider mb-1">
                                Edit Data</p>
                            <h3 class="text-xl md:text-2xl font-bold text-white leading-tight">Edit Misi
                            </h3>
                        </div>
                    </div>
                    <button type="button"
                        ...
                        data-modal-hide="edit-misi-modal-{{ $misi->id }}">
            ...
            <!-- Modal body -->
            <form action="{{ route('admin.visi-misi.misi.update', $misi->id) }}" method="POST"
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <textarea id="misi-{{ $misi->id }}" name="misi" rows="8"
                                    ...
                                    placeholder="Masukkan deskripsi misi..." required>{{ $misi->misi }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <button type="button" data-modal-hide="edit-misi-modal-{{ $misi->id }}"
