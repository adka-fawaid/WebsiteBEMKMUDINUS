...
<div class="overflow-x-auto">
    <div class="flex items-center justify-between mb-4">
        <h3 class="text-lg font-bold text-gray-900">Data Misi Organisasi</h3>
        <button type="button" data-modal-target="add-misi-modal" data-modal-toggle="add-misi-modal"
        ...
        <thead>
            <tr class="bg-gradient-to-r from-gray-50 to-blue-50 border-b border-gray-200">
                ...
                <th scope="col" class="px-6 py-4 text-left font-bold">
                    <span class="text-xs font-extrabold text-gray-700 uppercase tracking-wider">Deskripsi Misi</span>
                </th>
            ...
            @forelse ($misiList as $index => $misi)
                <tr
                    ...
                    <td class="px-6 py-5 text-center">
                        <span
                            class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-indigo-100 text-indigo-700 font-bold text-sm group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300">
                            {{ $index + 1 }}
                        </span>
                    </td>
                    <td class="px-6 py-5">
                    ...
                    <td class="px-6 py-5">
                        <div class="flex items-center justify-center gap-2">
                            <button type="button" data-modal-target="edit-misi-modal-{{ $misi->id }}"
                                data-modal-toggle="edit-misi-modal-{{ $misi->id }}"
                            ...
                            <button type="button" data-modal-target="delete-misi-modal-{{ $misi->id }}"
                                data-modal-toggle="delete-misi-modal-{{ $misi->id }}"
                ...
                <!-- Include Edit Modal -->
                @include('admin.visi-misi.misi.edit', ['misi' => $misi])

                <!-- Include Delete Modal -->
                @include('admin.visi-misi.misi.delete', ['misi' => $misi])
            @empty
                <tr>
                    <td colspan="3" class="px-6 py-16 text-center">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <p class="text-sm text-gray-500">Belum ada data misi. Klik tombol "Tambah Misi" untuk
                                menambah data.</p>
                        </div>
                    </td>
                </tr>
...
<!-- Include Create Misi Modal -->
@include('admin.visi-misi.misi.create')
