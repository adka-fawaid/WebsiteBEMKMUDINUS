<!-- Add Misi Modal -->
<div id="add-misi-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl h-full flex items-center justify-center">
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-h-[90vh] flex flex-col">
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl md:text-2xl font-bold text-white leading-tight">Misi Baru</h3>
                        </div>
                    </div>
                    <button type="button"
                        ...
                        data-modal-hide="add-misi-modal">
            ...
            <!-- Modal body -->
            <form action="{{ route('admin.visi-misi.misi.store') }}" method="POST"
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                <label for="misi"
                                    ...
                                    Misi</label>
                                <textarea id="misi" name="misi" rows="8"
                                    ...
                                    placeholder="Masukkan deskripsi misi..." required></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <button type="button" data-modal-hide="add-misi-modal"
