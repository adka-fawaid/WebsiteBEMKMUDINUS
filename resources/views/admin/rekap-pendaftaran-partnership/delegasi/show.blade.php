<!-- Modal Show Detail Delegasi -->
<div id="show-delegasi-{{ $delegasi->id }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-3xl h-full flex items-center justify-center">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-h-[90vh] flex flex-col">
            ...
            <div
                ...
                <div class="relative flex items-center justify-between">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="show-delegasi-{{ $delegasi->id }}" aria-label="Close">
            ...
            <div class="p-4 md:p-6 space-y-6 overflow-y-auto flex-1">
                <div class="space-y-4">
                    <!-- Layout for all attributes from Pendaftaran Delegasi -->
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-base text-gray-900">{{ $delegasi->nomor_pendaftaran }}</p>
                            </div>
                        </div>
                        <!-- Email -->
                        <div
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-base text-gray-900 break-all">{{ $delegasi->email }}</p>
                            </div>
                        </div>
                        <!-- Nama Lengkap -->
                        <div
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-base text-gray-900">{{ $delegasi->nama_lengkap }}</p>
                            </div>
                        </div>
                        <!-- Nama Instansi -->
                        <div
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-base text-gray-900">{{ $delegasi->nama_instansi }}</p>
                            </div>
                        </div>
                        <!-- Nomor Telepon -->
                        <div
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-base text-gray-900">{{ $delegasi->nomor_telepon }}</p>
                            </div>
                        </div>
                        <!-- Nama Acara -->
                        <div
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-base text-gray-900">{{ $delegasi->nama_acara }}</p>
                            </div>
                        </div>
                    </div>
                    <!-- Deskripsi Acara -->
                    ...
                    <div
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-xs font-medium text-gray-500 uppercase mb-1">Surat Undangan</p>
                            @if ($delegasi->surat_undangan)
                                <a href="{{ asset('storage/' . $delegasi->surat_undangan) }}" target="_blank"
                                    class="text-blue-600 hover:text-blue-800 font-semibold break-all inline-flex items-center gap-2">
                                    <span class="truncate">{{ basename($delegasi->surat_undangan) }}</span>
                            ...
                            @else
                                <span class="text-gray-400">Tidak ada file surat undangan</span>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-end p-4 md:p-5 border-t border-gray-200 flex-shrink-0">
                <button data-modal-hide="show-delegasi-{{ $delegasi->id }}" type="button"
