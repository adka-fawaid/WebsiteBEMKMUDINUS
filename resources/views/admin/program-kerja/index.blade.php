                                ...
                                <thead>
                                    <tr class="bg-gradient-to-r from-gray-50 to-blue-50 border-b border-gray-200">
                                        ...
                                        <th scope="col" class="px-6 py-4 text-center font-bold w-32">
                                            <span
                                                class="text-xs font-extrabold text-gray-700 uppercase tracking-wider">Pendaftaran</span>
                                        </th>
                                        ...
                                        <tr
                                            ...
                                            <td class="px-6 py-5 text-center">
                                                <span
                                                    ...
                                                    @if ($item->kategori === 'Rencana Kerja Tahunan')
                                                        RKT
                                                    @elseif($item->kategori === 'Non Rencana Kerja Tahunan')
                                                        Non RKT
                                                    @else
                                                        Duta Kampus
                                                    @endif
                                            ...
                                            <td class="px-6 py-5 text-center">
                                                @if ($item->pendaftaran)
                                                    <span
                                                        class="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-green-400/20 to-emerald-200/60 text-green-700 border border-green-300 shadow-sm">
                                                ...
                                                @else
                                                    <span
                                                        class="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-gray-200/60 to-gray-100/80 text-gray-500 border border-gray-300 shadow-sm">
