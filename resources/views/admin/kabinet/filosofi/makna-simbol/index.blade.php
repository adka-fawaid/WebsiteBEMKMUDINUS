...
<div class="overflow-x-auto">
    <div class="flex items-center justify-between mb-4">
        <h3 class="text-lg font-bold text-gray-900">Data Makna Simbol</h3>
        <button type="button" data-modal-target="add-makna-simbol-modal" data-modal-toggle="add-makna-simbol-modal"
    ...
    <table class="w-full">
        <thead>
            <tr class="bg-gradient-to-r from-gray-50 to-blue-50 border-b border-gray-200">
                ...
                <th scope="col" class="px-6 py-4 text-center font-bold">
                    <span class="text-xs font-extrabold text-gray-700 uppercase tracking-wider">Simbol</span>
                </th>
                <th scope="col" class="px-6 py-4 text-center font-bold">
                    <span class="text-xs font-extrabold text-gray-700 uppercase tracking-wider">Makna</span>
                </th>
        ...
        <tbody>
            @forelse ($maknaSimbolList as $index => $simbol)
                <tr
                    ...
                    <td class="px-6 py-5 text-center">{{ $simbol->simbol }}</td>
                    <td class="px-6 py-5 text-center">{{ $simbol->makna }}</td>
                    <td class="px-6 py-5 text-center">
                        <div class="flex items-center justify-center gap-2">
                            <button type="button" data-modal-target="edit-makna-simbol-modal-{{ $simbol->id }}"
                                data-modal-toggle="edit-makna-simbol-modal-{{ $simbol->id }}"
                            ...
                            <button type="button" data-modal-target="delete-makna-simbol-modal-{{ $simbol->id }}"
                                data-modal-toggle="delete-makna-simbol-modal-{{ $simbol->id }}"
                        ...
                        @include('admin.kabinet.filosofi.makna-simbol.edit', ['simbol' => $simbol])
                        @include('admin.kabinet.filosofi.makna-simbol.delete', ['simbol' => $simbol])
                    </td>
                </tr>
            @empty
                <tr>
                    <td colspan="4" class="px-6 py-16 text-center">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <p class="text-sm text-gray-500">Belum ada data makna simbol. Klik tombol "Tambah Makna
                                Simbol" untuk
                                menambah data.</p>
                        </div>
                    </td>
...
@include('admin.kabinet.filosofi.makna-simbol.create')
