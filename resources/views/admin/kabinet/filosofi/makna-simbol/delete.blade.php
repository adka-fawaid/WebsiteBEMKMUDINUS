<!-- Delete Makna Simbol Modal -->
<div id="delete-makna-simbol-modal-{{ $simbol->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-xs font-semibold text-red-100 uppercase tracking-wider mb-1">
                                Konfirmasi</p>
                            <h3 class="text-xl font-bold text-white leading-tight">Hapus Makna Simbol
                            </h3>
                        </div>
                    </div>
                    <button type="button"
                        ...
                        data-modal-hide="delete-makna-simbol-modal-{{ $simbol->id }}">
            ...
            <div class="p-6">
                <div class="flex items-start gap-4 mb-6 text-left">
                    ...
                    <div class="flex-1 text-left">
                        ...
                        <p class="text-sm text-gray-600 leading-relaxed mb-3">
                            Anda akan menghapus data makna simbol ini.
                        </p>
                ...
                <div class="flex items-center justify-end gap-3">
                    <!-- Action buttons -->
                    <form action="{{ route('admin.kabinet.filosofi.makna-simbol.destroy', $simbol->id) }}"
                        method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="button" data-modal-hide="delete-makna-simbol-modal-{{ $simbol->id }}"
