<!-- Add Makna Simbol Modal -->
<div id="add-makna-simbol-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl h-full flex items-center justify-center">
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-h-[90vh] flex flex-col">
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl md:text-2xl font-bold text-white leading-tight">Makna Simbol Baru</h3>
                        </div>
                    </div>
                    <button type="button"
                        ...
                        data-modal-hide="add-makna-simbol-modal">
            ...
            <!-- Modal body -->
            <form action="{{ route('admin.kabinet.filosofi.makna-simbol.store', $kabinet->id) }}" method="POST"
                class="flex-1 flex flex-col overflow-hidden">
                @csrf
                <input type="hidden" name="kabinet_id" value="{{ $kabinet->id }}">
                ...
                <div class="flex-1 overflow-y-auto p-4 md:p-6">
                    <div
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                <label for="simbol"
                                    class="block text-xs font-medium text-gray-900 uppercase tracking-wide mb-2">Simbol</label>
                                <input type="text" id="simbol" name="simbol"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                    placeholder="Masukkan simbol..." required>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <textarea id="makna" name="makna" rows="8"
                                    ...
                                    placeholder="Masukkan deskripsi makna..." required></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <button type="button" data-modal-hide="add-makna-simbol-modal"
