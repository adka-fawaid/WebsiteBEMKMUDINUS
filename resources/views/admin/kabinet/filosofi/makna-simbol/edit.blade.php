<!-- Edit Makna Simbol Modal -->
<div id="edit-makna-simbol-modal-{{ $simbol->id }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl h-full flex items-center justify-center">
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-h-[90vh] flex flex-col">
            ...
            <div
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-xs font-semibold text-yellow-100 uppercase tracking-wider mb-1">
                                Edit Data</p>
                            <h3 class="text-xl md:text-2xl font-bold text-white leading-tight">Edit Makna Simbol
                            </h3>
                        </div>
                    </div>
                    <button type="button"
                        ...
                        data-modal-hide="edit-makna-simbol-modal-{{ $simbol->id }}">
            ...
            <!-- Modal body -->
            <form action="{{ route('admin.kabinet.filosofi.makna-simbol.update', [$simbol->kabinet_id, $simbol->id]) }}"
                ...
                <div class="flex-1 overflow-y-auto p-4 md:p-6">
                    <div
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                <label for="simbol"
                                    class="block text-xs font-medium text-gray-900 uppercase tracking-wide mb-2 text-left">Simbol</label>
                                <input type="text" id="simbol" name="simbol"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                    placeholder="Masukkan simbol..." required value="{{ $simbol->simbol }}">
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <textarea id="makna" name="makna" rows="8"
                                    ...
                                    placeholder="Masukkan deskripsi makna..." required>{{ $simbol->makna }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <button type="button" data-modal-hide="edit-makna-simbol-modal-{{ $simbol->id }}"
