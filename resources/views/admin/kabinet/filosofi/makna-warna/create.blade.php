<!-- Add Makna Warna Modal -->
<div id="add-makna-warna-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl h-full flex items-center justify-center">
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-h-[90vh] flex flex-col">
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl md:text-2xl font-bold text-white leading-tight">Makna Warna Baru</h3>
                        </div>
                    </div>
                    <button type="button"
                        ...
                        data-modal-hide="add-makna-warna-modal">
            ...
            <!-- Modal body -->
            <form action="{{ route('admin.kabinet.filosofi.makna-warna.store', $kabinet->id) }}" method="POST"
                ...
                <div class="flex-1 overflow-y-auto p-4 md:p-6">
                    <div
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                <label for="warna"
                                    class="block text-xs font-medium text-gray-900 uppercase tracking-wide mb-2">Warna</label>
                ...
                <div
                    ...
                    <button type="button" data-modal-hide="add-makna-warna-modal"
