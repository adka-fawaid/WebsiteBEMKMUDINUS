...
<div class="overflow-x-auto">
    <div class="flex items-center justify-between mb-4">
        <h3 class="text-lg font-bold text-gray-900">Data Makna Warna</h3>
        <button type="button" data-modal-target="add-makna-warna-modal" data-modal-toggle="add-makna-warna-modal"
    ...
    <table class="w-full">
        <thead>
            <tr class="bg-gradient-to-r from-gray-50 to-blue-50 border-b border-gray-200">
                ...
                <th scope="col" class="px-6 py-4 text-center font-bold">
                    <span class="text-xs font-extrabold text-gray-700 uppercase tracking-wider">Warna</span>
                </th>
                <th scope="col" class="px-6 py-4 text-center font-bold">
        ...
        <tbody>
            @forelse ($maknaWarnaList as $index => $warna)
                <tr
                    ...
                    <td class="px-6 py-5 text-center">{{ $warna->warna }}</td>
                    <td class="px-6 py-5 text-center">{{ $warna->makna }}</td>
                    <td class="px-6 py-5 text-center">
                        <div class="flex items-center justify-center gap-2">
                            <button type="button" data-modal-target="edit-makna-warna-modal-{{ $warna->id }}"
                                data-modal-toggle="edit-makna-warna-modal-{{ $warna->id }}"
                            ...
                            <button type="button" data-modal-target="delete-makna-warna-modal-{{ $warna->id }}"
                                data-modal-toggle="delete-makna-warna-modal-{{ $warna->id }}"
                        ...
                        @include('admin.kabinet.filosofi.makna-warna.edit', ['warna' => $warna])
                        @include('admin.kabinet.filosofi.makna-warna.delete', ['warna' => $warna])
                    </td>
                </tr>
            @empty
                <tr>
                    <td colspan="4" class="px-6 py-16 text-center">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <p class="text-sm text-gray-500">Belum ada data makna warna. Klik tombol "Tambah Makna
                                Warna" untuk
                                menambah data.</p>
                        </div>
                    </td>
...
@include('admin.kabinet.filosofi.makna-warna.create')
