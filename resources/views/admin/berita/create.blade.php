<!-- Add Berita Modal -->
<div id="add-berita-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-h-[90vh] flex flex-col">
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl md:text-2xl font-bold text-white leading-tight">Berita Baru</h3>
                        </div>
                    </div>
                    <button type="button"
                        ...
                        data-modal-hide="add-berita-modal">
            ...
            <form action="{{ route('admin.berita.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="flex-1 overflow-y-auto p-4 md:p-6 space-y-4">
                    ...
                    <div
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                <label for="slug"
                                    class="block text-xs font-medium text-gray-900 uppercase tracking-wide mb-2">Slug</label>
                                <input type="text" id="slug" name="slug"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                    placeholder="contoh-slug-berita" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-4 items-start">
                            ...
                            <div class="flex-1">
                                <div
                                    ...
                                    <input type="file" id="gambar-create" name="gambar" accept="image/*"
                    ...
                    <div
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <div
                                    class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 hover:border-amber-400 transition-colors duration-300">
                                    <input type="file" id="dokumen" name="dokumen"
                                        accept=".pdf,.doc,.docx,.ppt,.pptx"
                                        class="absolute inset-0 w-full h-full opacity-0 cursor-pointer"
                                        onchange="document.getElementById('dokumen-name-create').textContent = this.files[0] ? 'File dipilih: ' + this.files[0].name : ''">
                                    <div class="text-center">
                                        ...
                                        <p class="text-xs text-gray-500">PDF, DOC, DOCX, PPT, PPTX hingga 5MB</p>
                                    </div>
                                </div>
                                <p class="mt-2 text-xs text-gray-500" id="dokumen-name-create"></p>
                            </div>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <button type="button" data-modal-hide="add-berita-modal"
