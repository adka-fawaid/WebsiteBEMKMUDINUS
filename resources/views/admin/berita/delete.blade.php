<!-- Delete Modal -->
<div id="delete-berita-modal-{{ $berita->id }}" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl font-bold text-white leading-tight">Hapus Berita</h3>
                        </div>
                    </div>
                    <button type="button"
                        ...
                        data-modal-hide="delete-berita-modal-kontakitem->id }}">
            ...
            <div class="p-6">
                <div class="flex items-start gap-4 mb-6">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600 leading-relaxed mb-3">
                            Anda akan menghapus berita <strong>kontakitem->judul }}</strong>.
                        </p>
                ...
                <div class="flex items-center justify-end gap-3">
                    <form action="{{ route('admin.berita.destroy', $berita->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="button" data-modal-hide="delete-berita-modal-{{ $berita->id }}"
