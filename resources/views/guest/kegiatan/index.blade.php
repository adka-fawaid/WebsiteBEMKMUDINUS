        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
            ...
            <div class="mb-6 md:mb-8 text-center mt-5">
                ...
                <p class="text-gray-600 text-sm md:text-base max-w-2xl mx-auto">
                    Program kerja dan kegiatan yang dilaksanakan oleh BEM KM UDINUS
                </p>
            </div>

            <!-- Search & Filter -->
            <div class="mb-8">
                <form method="GET" action="{{ route('guest.kegiatan.index') }}" class="max-w-4xl mx-auto">
                    ...
                    @if (request('search') || request('kategori'))
                        <div class="mt-4 flex items-center gap-3 flex-wrap">
                            ...
                            @if (request('search'))
                                <a href="{{ route('guest.kegiatan.index', ['kategori' => request('kategori')]) }}"
                            ...
                            @endif
                            @if (request('kategori'))
                                <a href="{{ route('guest.kegiatan.index', ['search' => request('search')]) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    <div class="group">
                        <div
                            ...
                            <div class="p-4 md:p-5">
                                ...
                                <!-- Selengkapnya Buttons -->
                                <a href="{{ route('guest.kegiatan.detail', $kegiatan->id) }}" rel="noopener noreferrer"
                ...
                @empty
                    <div class="col-span-full text-center py-12">
                        ...
                        <h3 class="text-gray-700 font-bold text-lg mb-2">Belum Ada Kegiatan</h3>
                        <p class="text-gray-500 text-sm">Kegiatan akan segera hadir</p>
                    </div>
                @endforelse
            </div>
        </div>
