<section
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        <div class="text-center mb-4">
            <span
                class="inline-block text-orange-500 font-semibold text-lg uppercase tracking-wider mb-2">Pembukaan</span>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
            ...
            <div class="lg:col-span-5 text-center lg:-ml-20">
                <div class="relative inline-block group">
                    <!-- Card Container -->
                    <div
                        class="group bg-white rounded-3xl shadow-xl shadow-blue-500/10 border border-gray-100 transform transition-all duration-500 hover:-translate-y-2 overflow-visible max-w-lg mx-auto">
                        ...
                        <div class="px-4 pb-6 -mt-8 relative z-10">
                            <div
                                ...
                                <div
                                    class="inline-flex items-center justify-center px-3 py-0.5 rounded-full bg-orange-50 text-orange-700 text-[10px] md:text-xs font-bold tracking-wide uppercase">
                                    Presiden Mahasiswa BEM KM UDINUS {{ $kabinet->periode }}
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="lg:col-span-7">
                ...
                <div class="space-y-6">
                    <div
                        class="relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 border-l-4 border-blue-500 shadow-lg shadow-blue-500/5">

                        <svg class="absolute top-4 left-4 w-8 h-8 text-orange-500" fill="currentColor"
                            viewBox="0 0 32 32">
                            <path
                        ...
                        <div class="px-6">
                            <p
                                class="text-gray-700 leading-relaxed text-sm md:text-base lg:text-lg text-justify whitespace-pre-line">
                                {{ $sambutan->sambutan }}
                            </p>
                        </div>

                        <svg class="absolute bottom-4 right-4 w-8 h-8 text-orange-500 rotate-180" fill="currentColor"
                            viewBox="0 0 32 32">
                            <path
                                d="M9.352 4C4.456 7.456 1 13.12 1 19.36c0 5.088 3.072 8.064 6.624 8.064 3.36 0 5.856-2.688 5.856-5.856 0-3.168-2.208-5.472-5.088-5.472-.576 0-1.344.096-1.536.192.48-3.264 3.552-7.104 6.624-9.024L9.352 4zm16.512 0c-4.8 3.456-8.256 9.12-8.256 15.36 0 5.088 3.072 8.064 6.624 8.064 3.264 0 5.856-2.688 5.856-5.856 0-3.168-2.304-5.472-5.184-5.472-.576 0-1.248.096-1.44.192.48-3.264 3.456-7.104 6.528-9.024L25.864 4z" />
                        </svg>
