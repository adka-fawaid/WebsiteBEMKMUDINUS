<section id="hero-home"
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
            class="absolute top-10 right-10 w-96 h-96 bg-gradient-to-br from-blue-200/30 to-blue-300/20 rounded-full blur-3xl animate-pulse">
        </div>
        <div
            class="absolute bottom-20 left-20 w-[500px] h-[500px] bg-gradient-to-tr from-indigo-200/25 to-blue-200/15 rounded-full blur-3xl">
        </div>
        <div
            class="absolute top-1/2 right-1/3 w-80 h-80 bg-gradient-to-bl from-orange-200/20 to-orange-100/10 rounded-full blur-3xl">
        </div>

        <!-- Subtle geometric patterns -->
        <div class="absolute inset-0 opacity-[0.03]"
            style="background-image: radial-gradient(circle at 2px 2px, #1e40af 1px, transparent 0); background-size: 40px 40px;">
        </div>

        <!-- Floating accent elements -->
        <div class="absolute top-1/4 left-1/4 w-2 h-2 bg-blue-400/30 rounded-full animate-ping"></div>
        <div class="absolute top-3/4 right-1/4 w-3 h-3 bg-orange-400/30 rounded-full animate-ping"
            style="animation-delay: 1s;"></div>
        <div class="absolute bottom-1/3 left-1/2 w-2 h-2 bg-indigo-400/30 rounded-full animate-ping"
            style="animation-delay: 2s;"></div>
    </div>

    <!-- Decorative top border -->
    <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-blue-500/50 to-transparent">
    </div>

    <!-- Content -->
    <div class="relative z-10 w-full">
        <div class="container mx-auto px-6 lg:px-12">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-screen py-16 lg:py-20">
                <!-- Left Content -->
                <div class="flex flex-col justify-center pl-0 lg:pl-8">
                    <!-- Main Heading with enhanced styling -->
                    <h1
                        class="font-extrabold tracking-tight text-blue-900 mb-2 text-5xl sm:text-6xl md:text-7xl leading-tight drop-shadow-sm">
                        BEM KM UDINUS
                    </h1>

                    <h1
                        class="font-extrabold tracking-tight text-[#1C4D8D] mb-5 text-1xl sm:text-4xl md:text-5xl leading-tight drop-shadow-sm">
                        Kabinet <span class="text-[#FF8C00]">Aksa Sinergi</span>
                    </h1>

                    <!-- Decorative Divider -->
                    <div class="flex items-center mb-5">
                        <div class="h-1 w-28 bg-gradient-to-r from-blue-600 via-orange-500 to-blue-400 rounded-full">
                        </div>
                    </div>
                    ...
                    <p class="text-gray-700 mb-5 text-md sm:text-lg font-medium leading-relaxed max-w-2xl">
                        ...
                        untuk Keluarga Besar mahasiswa UDINUS.
                    </p>
                    ...
                    <div class="w-full relative">
                        ...
                        <div class="group relative rounded-2xl overflow-hidden shadow-2xl shadow-blue-900/20 border-4 border-white/40 backdrop-blur-sm bg-white/10"
                            ...
                            <div class="swiper-slider w-full h-full relative" id="heroSlider">
                                <!-- Slide 1: Struktural -->
                                <div class="swiper-slide absolute inset-0 transition-opacity duration-700 opacity-100"
                                    data-slide="0"
                                ...
                                <div class="swiper-slide absolute inset-0 transition-opacity duration-700 opacity-0 pointer-events-none"
                                    data-slide="1"
                                    style="background-image: url('{{ asset('img/background/foto_bersama.jpeg') }}'); background-position: center; background-size: cover;">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/60 via-black/25 to-transparent">
                            ...
                            <button
                                class="slider-prev absolute left-4 top-1/2 -translate-y-1/2 z-20 bg-white/30 hover:bg-white/50 backdrop-blur-sm text-white rounded-full p-3 shadow-lg opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 hover:scale-110"
                            ...
                            <button
                                class="slider-next absolute right-4 top-1/2 -translate-y-1/2 z-20 bg-white/30 hover:bg-white/50 backdrop-blur-sm text-white rounded-full p-3 shadow-lg opacity-0 translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 hover:scale-110"
                            ...
                            <div class="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 flex gap-3">
                                <button
                                    class="slider-dot w-3 h-3 rounded-full bg-white/80 shadow-md transition-all cursor-pointer hover:scale-125"
                                    data-dot="0" onclick="heroSliderGo(0)"></button>
                                <button
                                    class="slider-dot w-3 h-3 rounded-full bg-white/40 shadow-md transition-all cursor-pointer hover:scale-125"
                                    data-dot="1" onclick="heroSliderGo(1)"></button>
                                <button
                                    class="slider-dot w-3 h-3 rounded-full bg-white/40 shadow-md transition-all cursor-pointer hover:scale-125"
                                    data-dot="2" onclick="heroSliderGo(2)"></button>
                            </div>
                        </div>

                        <!-- Decorative glow behind slider -->
                        <div
                            class="absolute -inset-4 bg-gradient-to-r from-blue-400/20 to-indigo-400/20 rounded-3xl blur-2xl -z-10">
                        </div>
                    </div>
                </div>
            </div>
