<div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" id="nama_lengkap" name="nama_lengkap" value="{{ old('nama_lengkap') }}" required
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition @error('nama_lengkap') border-red-500 @enderror">
                @error('nama_lengkap')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" id="nama_instansi" name="nama_instansi" value="{{ old('nama_instansi') }}"
                    required
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition @error('nama_instansi') border-red-500 @enderror">
                @error('nama_instansi')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="tel" id="nomor_telepon" name="nomor_telepon" value="{{ old('nomor_telepon') }}"
                    required
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition @error('nomor_telepon') border-red-500 @enderror">
                @error('nomor_telepon')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
    ...
    <div class="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100">
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Detail acara kolaborasi</p>
            </div>
        </div>
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="text" id="nama_acara" name="nama_acara" value="{{ old('nama_acara') }}" required
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition @error('nama_acara') border-red-500 @enderror">
                @error('nama_acara')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <textarea id="deskripsi_acara" name="deskripsi_acara" rows="4" required
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition @error('deskripsi_acara') border-red-500 @enderror">{{ old('deskripsi_acara') }}</textarea>
    ...
    <div class="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100">
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Unggah proposal kolaborasi</p>
            </div>
        </div>
        <div>
            <!-- Proposal Acara -->
            <div>
                <label for="proposal_acara" class="block text-sm font-semibold text-gray-700 mb-2">
                    Proposal Kolaborasi (PDF) <span class="text-red-500">*</span>
                </label>
                <input type="file" id="proposal_acara" name="proposal_acara" accept=".pdf" required
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition @error('proposal_acara') border-red-500 @enderror">
    ...
    <div class="bg-green-50 border-l-4 border-green-500 p-4 rounded-r-lg">
        <div class="flex items-start">
            ...
            <div>
                <p class="text-sm font-semibold text-green-800">Informasi Penting</p>
                <p class="text-sm text-green-700 mt-1">Setelah pendaftaran, Anda akan menerima nomor pendaftaran dengan
                    format <strong>KLB-{{ date('Y') }}-XXX</strong>. Simpan nomor ini untuk keperluan tracking.</p>
            </div>
        </div>
    </div>

    <!-- Additional Info -->
    <div class="bg-gradient-to-r from-green-100 to-emerald-100 rounded-xl p-6 border border-green-200">
        ...
        <ul class="space-y-2 text-sm text-green-800">
            <li class="flex items-start gap-2">
                ...
                <span>Event bersama (seminar, workshop, kompetisi)</span>
            </li>
            <li class="flex items-start gap-2">
                <svg class="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd"
                ...
                <span>Program pengembangan mahasiswa</span>
            </li>
            <li class="flex items-start gap-2">
                <svg class="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd"
                ...
                <span>Pertukaran mahasiswa atau delegasi</span>
            </li>
        </ul>
    </div>
</div>
