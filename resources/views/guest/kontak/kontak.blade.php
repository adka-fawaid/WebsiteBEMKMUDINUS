...
@section('content')
<!-- kontak -->
<section id="kontak" style="margin-top: 100px;">
    <div class="container py-5">
        ...
        <div class="header-kontak text-center" style="margin-top: 50px;">
            <h2 class="fw-bold">Hubungi BEM KM UDINUS</h2>
        </div>
            ...
            <div class="col-lg-4" >
                <div class="card border-0">
                    ...
                    <div class="card-body">
                        ...
                        <a href="/detail_kontak/{{ $item->slug }}" class="text-decoration-none text-danger">Selengkapnya</a>
                    </div>
                </div>
            </div>
            @endforeach
